...
| :--------------------------------------------: | :--------------------------------------------: |
| ![](cornell.2021-10-04_02-10-06z.5000samp.png) | ![](cornell.2021-10-04_01-57-31z.5000samp.png) |

#### Stochastic Sampled Anti-Aliasing

|               1x Anti-Aliasing (Feature OFF)                |                      4x Anti-Aliasing                       |
| :---------------------------------------------------------: | :---------------------------------------------------------: |
| ![](cornell.2021-10-04_01-14-01z.5000samp-antialias-1x.png) | ![](cornell.2021-10-04_01-07-24z.5000samp-antialias-4x.png) |

#### Physically-Based Depth of Field

|       Pinhole Camera Model (Feature OFF)       |             Thin-Lens Camera Model             |
| :--------------------------------------------: | :--------------------------------------------: |
| ![](cornell.2021-10-05_02-45-59z.5000samp.png) | ![](cornell.2021-10-05_02-40-08z.5000samp.png) |
...
| :-----------------------------------------------------: | :-----------------------------------------------------: |
| ![](cornell.2021-10-21_22-45-59z.5000samp.original.png) | ![](cornell.2021-10-21_22-47-57z.5000samp.original.png) |

|                  PBRT, 100 iterations                  |        PBRT, 100 iterations, À-Trous Denoising         |
| :----------------------------------------------------: | :----------------------------------------------------: |
| ![](cornell.2021-10-21_21-56-47z.100samp.original.png) | ![](cornell.2021-10-21_22-57-08z.100samp.denoised.png) |
...
| :----------------------------------------------------: | :----------------------------------------------------: |
| ![](cornell.2021-10-22_00-46-51z.100samp.denoised.png) | ![](cornell.2021-10-22_00-47-47z.100samp.denoised.png) |
...
| :---------------------------: | :----------------------------: | :----------------------------: | :-----------------------------: |
| ![](denoise.filtersize.6.png) | ![](denoise.filtersize.15.png) | ![](denoise.filtersize.32.png) | ![](denoise.filtersize.100.png) |
...
| :----------------------: | :-----------------------: | :-------------------------: |
| ![](denoise-diffuse.png) | ![](denoise-specular.png) | ![](denoise-refraction.png) |
...
| :----------------------: | :------------------------------------: |
| ![](denoise-cornell.png) | ![](denoise-cornell-ceiling-light.png) |
...
| :---------------------: | :----------------------: | :----------------------: |
| ![](denoise-iter-1.png) | ![](denoise-iter-10.png) | ![](denoise-iter-25.png) |

|      Iteration = 50      |      Iteration = 100      |
| :----------------------: | :-----------------------: |
| ![](denoise-iter-50.png) | ![](denoise-iter-100.png) |
